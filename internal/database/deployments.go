...
func (db *DB) CreateDeployment(d *Deployment) error {
	return db.QueryRow(`
		INSERT INTO deployments (project_name, container_id, image, port, status, url, recette_name)
		VALUES ($1,$2,$3,$4,$5,$6,$7)
		RETURNING id, created_at`,
		d.ProjectName, d.ContainerID, d.Image, d.Port, d.Status, d.URL, nilIfEmpty(d.RecetteName),
...
func (db *DB) GetDeploymentByID(id string) (*Deployment, error) {
	...
	err := db.QueryRow(`
		SELECT id, project_name, container_id, image, port, status, url, recette_name, created_at
